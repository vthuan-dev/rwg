...
export default function XocDiaPage() {
  ...
  if (isAuthenticated === null || !isAuthenticated) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#050302] text-white select-none">
  ...
  if (loading) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#050302] text-white select-none overflow-hidden font-sans">
